...
b.scan(g).setName("scan2g").shuffle(pf).setName("shuffle_2g").hashEquiJoin(iterateInput,Array(0), Array(), Array(0), Array(1)).setName("join").shuffle(pf).setName("shuffle_j").endIterate(iterateInput)
