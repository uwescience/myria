...
public class MergeTest extends SystemTestBase {
  ...
  public void mergeTest() throws Exception {
    ...
    final SQLiteQueryScan scan1 = new SQLiteQueryScan("select * from " + testtable0Key, tableSchema);
    final SQLiteQueryScan scan2 = new SQLiteQueryScan("select * from " + testtable1Key, tableSchema);
