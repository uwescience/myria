...
public class MultithreadScanTest extends SystemTestBase {
  ...
  public void TwoThreadsTwoConnectionsSameDBFileTest() throws Exception {
    ...
    final SQLiteQueryScan scan3 = new SQLiteQueryScan("select * from " + testtableKey.toString("sqlite"), tableSchema);
    final SQLiteQueryScan scan4 = new SQLiteQueryScan("select * from " + testtableKey.toString("sqlite"), tableSchema);
