...
public class ParallelSQLLiteTest extends SystemTestBase {

  @Test
  public void parallelTestSQLite(final String[] args) throws DbException, IOException {
    createTable(WORKER_ID[0], "testtable1", "id int, name varchar(20)");
    createTable(WORKER_ID[1], "testtable1", "id int, name varchar(20)");
    createTable(WORKER_ID[0], "temptable1", "id int, name varchar(20)");
