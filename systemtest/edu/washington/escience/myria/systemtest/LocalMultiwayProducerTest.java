...
public class LocalMultiwayProducerTest extends SystemTestBase {
  ...
  public void localMultiwayProducerTest() throws Exception {
    ...
    workerPlans.put(workerIDs[0], new SingleQueryPlanWithArgs(new RootOperator[] { multiProducer1, cp1 }));
    workerPlans.put(workerIDs[1], new SingleQueryPlanWithArgs(new RootOperator[] { multiProducer2, cp2 }));
    ...
    TestUtils.assertTupleBagEqual(TestUtils.tupleBatchToTupleBag(expected), TestUtils.tupleBatchToTupleBag(TestUtils
