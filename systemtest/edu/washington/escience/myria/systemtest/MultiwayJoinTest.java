...
public class MultiwayJoinTest extends SystemTestBase {
  ...
  public void twoWayJoinUsingMultiwayJoinOperator2() throws Exception {
    ...
    CSVParser csv1 =
        new CSVParser(new FileReader(table1Worker1FilePath.toFile()), CSVFormat.DEFAULT);
    CSVParser csv2 =
        new CSVParser(new FileReader(table2Worker1FilePath.toFile()), CSVFormat.DEFAULT);
    CSVParser csv3 =
        new CSVParser(new FileReader(table1Worker2FilePath.toFile()), CSVFormat.DEFAULT);
    CSVParser csv4 =
        new CSVParser(new FileReader(table2Worker2FilePath.toFile()), CSVFormat.DEFAULT);
    ...
    final InMemoryOrderBy o1 =
        new InMemoryOrderBy(sc1, new int[] {0, 1}, new boolean[] {true, true});
    final InMemoryOrderBy o2 =
        new InMemoryOrderBy(sc2, new int[] {0, 1}, new boolean[] {true, true});
