...
public final class IPCConfigurations {
  ...
  public static ClientBootstrap createMasterIPCClientBootstrap(final Server theMaster) throws ConfigFileException {
    ...
    bootstrap.setOption("connectTimeoutMillis", Long.valueOf(theMaster
        .getRuntimeConfiguration(MyriaSystemConfigKeys.TCP_CONNECTION_TIMEOUT_MILLIS)));
    bootstrap.setOption("sendBufferSize", Long.valueOf(theMaster
        .getRuntimeConfiguration(MyriaSystemConfigKeys.TCP_SEND_BUFFER_SIZE_BYTES)));
    bootstrap.setOption("receiveBufferSize", Long.valueOf(theMaster
        .getRuntimeConfiguration(MyriaSystemConfigKeys.TCP_RECEIVE_BUFFER_SIZE_BYTES)));
    bootstrap.setOption("writeBufferLowWaterMark", Long.valueOf(theMaster
        .getRuntimeConfiguration(MyriaSystemConfigKeys.FLOW_CONTROL_WRITE_BUFFER_LOW_MARK_BYTES)));
    bootstrap.setOption("writeBufferHighWaterMark", Long.valueOf(theMaster
        .getRuntimeConfiguration(MyriaSystemConfigKeys.FLOW_CONTROL_WRITE_BUFFER_HIGH_MARK_BYTES)));
