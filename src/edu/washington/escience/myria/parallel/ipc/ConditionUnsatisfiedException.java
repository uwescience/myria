...
/**
 * Condition not satisfied. It is used in condition futures.
 * */
public class ConditionUnsatisfiedException extends Exception {
   ...
   * Default constructor.
   * */
  public ConditionUnsatisfiedException() {
    super();
  }
   ...
   *          method.
   */
  public ConditionUnsatisfiedException(final String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public ConditionUnsatisfiedException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public ConditionUnsatisfiedException(final Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.7
   */
  protected ConditionUnsatisfiedException(final String message, final Throwable cause, final boolean enableSuppression,
