...
public interface ShortMessageProcessor<PAYLOAD> extends Attachmentable {
   ...
   * @return true if the message is successfully processed.If the return value is false, the caller
   *         should pause to push data into the processor and do some message caching. If the return
   *         value is false and still the data are pushed into the processor, the semantic is
   *         undefined.
   * */
