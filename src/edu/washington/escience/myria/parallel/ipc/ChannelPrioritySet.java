...
public final class ChannelPrioritySet {
  ...
  /**
   * Creates a {@code PriorityBlockingQueue} with the specified initial capacity that orders its
   ...
   *        {@code null}, the {@linkplain Comparable natural ordering} of the elements will be used.
   ...
   *
   * It's implemented as first remove e from queue and then add e back. If e is not in queue, simply
   * add it to queue.
   *
   * @param e element.
