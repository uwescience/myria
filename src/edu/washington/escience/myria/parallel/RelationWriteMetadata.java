...
public class RelationWriteMetadata implements Serializable {
  ...
  /** The DistributeFunction used to distribute the relation across workers. */
   ...
   * @param temporary if {@code true}, then the relation will be not be added to the Catalog, and its tuple count will
   *        not be maintained.
   * @param distributeFunction the DistributeFunction used to distribute the relation across workers. */
  public RelationWriteMetadata(
      @Nonnull final RelationKey relationKey,
      @Nonnull final Schema schema,
      final boolean overwrite,
      final boolean temporary,
      @Nullable final DistributeFunction distributeFunction) {
  ...
  /** @return the DistributeFunction used to distribute this relation */
