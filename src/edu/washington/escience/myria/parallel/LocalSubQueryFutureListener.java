...
/**
 * Listens to the result of a {@link LocalSubQueryFuture}. The result of the asynchronous
 ...
 * 
 * {@link #operationComplete(LocalSubQueryFuture)} is directly called by a subquery thread.
 * Therefore, performing a time consuming task or a blocking operation in the handler method can
 * cause an unexpected pause during execution. If you need to perform a blocking operation on
 * subquery completion, try to execute the operation in a different thread using a thread pool.
 */
