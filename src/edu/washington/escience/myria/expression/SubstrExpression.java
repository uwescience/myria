...
public class SubstrExpression extends NAryExpression {
   ...
   */
  public SubstrExpression(final ExpressionOperator str, final ExpressionOperator beginIdx,
  ...
  public Type getOutputType(final ExpressionOperatorParameter parameters) {
    ...
    Preconditions.checkArgument(getChildren().get(2).getOutputType(parameters) == Type.INT_TYPE,
