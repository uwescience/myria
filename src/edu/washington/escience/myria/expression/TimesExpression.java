...
public class TimesExpression extends BinaryExpression {
  ...
  public String getJavaString(final ExpressionOperatorParameter parameters) {
    ...
    if (t == Type.INT_TYPE) {
      return getFunctionCallBinaryString("com.google.common.math.IntMath.checkedMultiply",
          parameters);
    } else if (t == Type.LONG_TYPE) {
      return getFunctionCallBinaryString("com.google.common.math.LongMath.checkedMultiply",
          parameters);
    }
