...
/**
 * Divide two operands in an expression tree. The return value is of type {@link Type.INT_TYPE} if
 * both operands are also INTs, and of type {@link Type.LONG_TYPE} otherwise.
 */
public class IntDivideExpression extends BinaryExpression {
  ...
  private final Set<Type> validTypes = ImmutableSet.<Type>builder().add(Type.LONG_TYPE)
      .add(Type.INT_TYPE).build();
  ...
  public String getJavaString(final ExpressionOperatorParameter parameters) {
    ...
    return new StringBuilder("com.google.common.math.DoubleMath.roundToLong(")
        .append(getInfixBinaryString("/", parameters)).append(", java.math.RoundingMode.DOWN)")
        .toString();
  }
}
