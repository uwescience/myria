...
public final class AtomicUtils {
  ...
  /**
   * Atomically do bitwise OR between the value in the AtomicInteger and the toOrValue, and set the
   * new value to the AtomicInteger and also return the new value.
   *
  ...
  /**
   * Atomically do bitwise AND between the value in the AtomicInteger and the toAndValue, and set
   * the new value to the AtomicInteger and also return the new value.
   *
   * @param ai the atomic variable to operate on
   ...
   * @param ai the AtomicInteger to operate on
   * @param value from the value get the index of the set bit from the least significant bit. Do the
