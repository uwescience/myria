...
@JsonSubTypes({
    ...
    @Type(name = "UnionAll", value = UnionAllEncoding.class), @Type(name = "Merge", value = MergeEncoding.class),
    @Type(name = "TableScan", value = TableScanEncoding.class), @Type(name = "Project", value = ProjectEncoding.class),
    @Type(name = "DirectApply", value = DirectApplyEncoding.class), @Type(name = "Apply", value = ApplyEncoding.class),
    @Type(name = "DbQueryScan", value = QueryScanEncoding.class), @Type(name = "Filter", value = FilterEncoding.class),
