...
import edu.washington.escience.myria.api.encoding.NChiladaDatasetEncoding;
...
public final class DatasetResource {
  ...
  @Path("/nchilada")
  @Consumes(MediaType.APPLICATION_JSON)
  public Response newNChiladaDataset(final NChiladaDatasetEncoding dataset, @Context final UriInfo uriInfo)
      throws DbException {
    dataset.validate();
