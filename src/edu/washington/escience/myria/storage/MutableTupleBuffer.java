...
public class MutableTupleBuffer implements ReadableTable, AppendableTable, Cloneable {
  ...
  @Override
  public final ByteBuffer getByteBuffer(final int col, final int row) {
    return getColumn(col, row).getByteBuffer(row % TupleBatch.BATCH_SIZE);
  }
  ...
  public final void replaceByteBuffer(
    ...
    getColumn(destColumn, destRow).replaceByteBuffer(value, destRow % TupleBatch.BATCH_SIZE);
  }
