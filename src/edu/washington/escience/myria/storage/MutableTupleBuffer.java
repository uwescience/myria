...
public class MutableTupleBuffer implements ReadableTable, AppendableTable, Cloneable {
  ...
  /**
   * <<<<<<< HEAD:src/edu/washington/escience/myria/TupleBuffer.java ======= Compare two cells in two TupleBuffers.
   * 
  ...
  /**
   * >>>>>>> master:src/edu/washington/escience/myria/storage/MutableTupleBuffer.java Append the specified value to the
   * specified destination column in this TupleBatchBuffer from the source column.
   * 
