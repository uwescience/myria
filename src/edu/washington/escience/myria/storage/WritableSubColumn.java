...
public final class WritableSubColumn implements WritableColumn {
	...
	/**
	 * Constructs a wrapper to present the specified column of the given table
	 * as a {@link WritableColumn}.
	 * 
	 * @param table
	 *            the table to be wrapped
	 * @param column
	 *            which column this object represents
	 */
	public WritableSubColumn(final AppendableTable table, final int column) {
		inner = Objects.requireNonNull(table, "inner");
		this.column = Preconditions.checkElementIndex(column,
				table.numColumns());
	}

	@Override
	public WritableColumn appendBoolean(final boolean value)
	...
	@Override
	public WritableColumn appendDateTime(final DateTime value)
			throws BufferOverflowException {
	...
	@Override
	public WritableColumn appendDouble(final double value)
			throws BufferOverflowException {
	...
	@Override
	public WritableColumn appendFloat(final float value)
			throws BufferOverflowException {
	...
	@Override
	public WritableColumn appendInt(final int value)
			throws BufferOverflowException {
	...
	@Override
	public WritableColumn appendLong(final long value)
			throws BufferOverflowException {
	...
	@Override
	@Deprecated
	public WritableColumn appendObject(final Object value)
			throws BufferOverflowException {
	...
	@Override
	public WritableColumn appendString(final String value)
			throws BufferOverflowException {
	...
	@Override
	public WritableColumn appendMyriaMatrix(final MyriaMatrix value)
			throws BufferOverflowException {
