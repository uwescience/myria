...
public class Tuple implements Cloneable, ReadableTable, Serializable {
	...
	public boolean getBoolean(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.BOOLEAN_TYPE);
	...
	public double getDouble(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.DOUBLE_TYPE);
	...
	public float getFloat(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.FLOAT_TYPE);
	...
	public int getInt(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.INT_TYPE);
	...
	public long getLong(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.LONG_TYPE);
	...
	public String getString(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.STRING_TYPE);
	...
	public MyriaMatrix getMyriaMatrix(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.MYRIAMATRIX_TYPE);
	...
	public DateTime getDateTime(final int column, final int row) {
		Preconditions
				.checkArgument(getSchema().getColumnType(column) == Type.DATETIME_TYPE);
	...
	public void set(final int columnIdx, final Object value) {
		getColumn(columnIdx).appendObject(
