...
public final class MyriaWorkerConfigurationModule extends ConfigurationModuleBuilder {
  ...
  public static final ConfigurationModule CONF = new MyriaWorkerConfigurationModule()
      ...
      .bindNamedParameter(WorkerFilesystemPath.class, WORKER_FILESYSTEM_PATH).build();
