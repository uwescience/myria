...
/**
 * An IntMutableColumn that simply wraps a read-only Protobuf message.
 * 
 */
public final class IntProtoMutableColumn extends IntMutableColumn {
   ...
   */
  public IntProtoMutableColumn(final IntColumnMessage message) {
