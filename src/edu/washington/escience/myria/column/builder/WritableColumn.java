...
public interface WritableColumn {
	 ...
	 *             if exceeds buffer up bound.
	 */
	WritableColumn appendBoolean(final boolean value)
			throws BufferOverflowException;
	 ...
	 *             if exceeds buffer up bound.
	 */
	WritableColumn appendDateTime(final DateTime value)
			throws BufferOverflowException;
	 ...
	 *             if exceeds buffer up bound.
	 */
	WritableColumn appendDouble(final double value)
			throws BufferOverflowException;
	 ...
	 *             if exceeds buffer up bound.
	 */
	WritableColumn appendFloat(final float value)
			throws BufferOverflowException;
	 ...
	 */
	@Deprecated
	WritableColumn appendObject(final Object value)
			throws BufferOverflowException;
	 ...
	 *             if exceeds buffer up bound.
	 */
	WritableColumn appendString(final String value)
			throws BufferOverflowException;
	 ...
	 *             if exceeds buffer up bound.
	 */
	WritableColumn appendMyriaMatrix(final MyriaMatrix value)
			throws BufferOverflowException;
