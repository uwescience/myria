...
public final class ColumnFactory {
	 ...
	 * 
	 * @param type
	 *            the Myria type of the returned Builder.
	...
	public static ColumnBuilder<?> allocateColumn(final Type type) {
		...
		case MYRIAMATRIX_TYPE:
			return new MyriaMatrixColumnBuilder();
		}
		throw new IllegalArgumentException(
				"Cannot allocate a ColumnBuilder for unknown type " + type);
	}
	 ...
	 */
	public static List<ColumnBuilder<?>> allocateColumns(
	 ...
	 * 
	 * @param message
	 *            the ColumnMessage to be deserialized.
	 * @param numTuples
	...
	public static Column<?> columnFromColumnMessage(
		...
		case MYRIAMATRIX:
			return MyriaMatrixColumnBuilder.buildFromProtobuf(message,
					numTuples);
		}
		return null;
	}
