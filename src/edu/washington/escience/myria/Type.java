...
/**
 * Class representing a type in Myria. Types are static objects defined by this
 * class; hence, the Type constructor is private.
 */
public enum Type implements Serializable {
	...
	INT_TYPE() {
		...
		public boolean filter(final SimplePredicate.Op op,
				final Column<?> intColumn, final int tupleIndex,
	...
	DOUBLE_TYPE() {
		@Override
		public boolean filter(final SimplePredicate.Op op,
				final Column<?> doubleColumn, final int tupleIndex,
				final Object operand) {
	...
	BOOLEAN_TYPE() {
		@Override
		public boolean filter(final SimplePredicate.Op op,
				final Column<?> booleanColumn, final int tupleIndex,
				final Object operand) {
	...
	STRING_TYPE() {
		@Override
		public boolean filter(final SimplePredicate.Op op,
				final Column<?> stringColumn, final int tupleIndex,
				final Object operand) {
	...
	LONG_TYPE() {
		@Override
		public boolean filter(final SimplePredicate.Op op,
				final Column<?> longColumn, final int tupleIndex,
				final Object operand) {
	...
	DATETIME_TYPE() {
		@Override
		public boolean filter(final SimplePredicate.Op op,
				final Column<?> dateColumn, final int tupleIndex,
				final Object operand) {
	 ...
	 * @return true if the #tupleIndex tuple in column satisfy the predicate,
	 *         else false.
	 * */
	public abstract boolean filter(SimplePredicate.Op op, Column<?> column,
			int tupleIndex, Object operand);
	...
	/**
	 * @return the value 0 if <code>x</code> is numerically equal to
	 *         <code>y</code>; a value less than 0 if <code>x</code> is
	 *         numerically less than <code>y</code>; and a value greater than 0
	 *         otherwise.
	 * @param x
	 *            the value to be compared in a tuple
	 * @param y
	 *            the operand
	 * */
	...
	/**
	 * @return value 0 if the <code>x</code> is equal to <code>y</code>; a value
	 *         less than 0 if <code>x</code> is lexicographically less than
	 *         <code>y</code>; and a value greater than 0 if this string is
	 *         otherwise.
	 * @param x
	 *            the value to be compared in a tuple
	 * @param y
	 ...
	 */
	private static boolean compare(final SimplePredicate.Op op,
			final long valueInTuple, final long operand) {
	 ...
	 */
	private static boolean compare(final SimplePredicate.Op op,
			final double valueInTuple, final double operand) {
		int compared = compareRaw(valueInTuple, operand);
		return evalOp(op, compared);
	}
	 ...
	 */
	private static boolean compare(final SimplePredicate.Op op,
			final boolean valueInTuple, final boolean operand) {
		int compared = compareRaw(valueInTuple, operand);
		return evalOp(op, compared);
	}
	 ...
	 */
	private static boolean compare(final SimplePredicate.Op op,
			final DateTime valueInTuple, final DateTime operand) {
		int compared = compareRaw(valueInTuple, operand);
		return evalOp(op, compared);
	}
	 ...
	 */
	private static boolean compare(final SimplePredicate.Op op,
			final int valueInTuple, final int operand) {
		int compared = compareRaw(valueInTuple, operand);
		return evalOp(op, compared);
	}
	 ...
	 */
	private static boolean compare(final SimplePredicate.Op op,
			final String valueInTuple, final String operand) {
		switch (op) {
		case LIKE:
	...
	/**
	 * Given an int that is the output of a <code>compareTo</code> function,
	 * return true if that comparison value satisfies that operator.
	 * 
	 * @param op
	 *            the comparison operator.
	 * @param compared
	 *            the comparison value, output using <code>compareTo</code>
	 *            semantics.
	 * @return true if that comparison value satisfies the operator.
	 */
	private static boolean evalOp(final SimplePredicate.Op op,
			final int compared) {
		switch (op) {
		case EQUALS:
			return compared == 0;
	...
	/**
	 * @return The name of the type usually used in the code. May be used to
