 ...
 * 
 */
public final class JoinEStep extends BinaryOperator {
	 ...
	 *        the children.
	 */
	public JoinEStep(final Operator left, final Operator right,
	 ...
	 *        the correct number of columns and column types.
	 */
	public JoinEStep(final List<String> outputColumns, final Operator left,
