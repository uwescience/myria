 ...
 * 
 */
public final class JoinMStepPartial extends BinaryOperator {
   ...
   */
  public JoinMStepPartial(final Operator left, final Operator right, final int[] compareIndx1,
   ...
   *        types.
   */
  public JoinMStepPartial(final List<String> outputColumns, final Operator left,
  ...
  protected void processLeftChildTB(final TupleBatch tb) {
    ...
    for (int row = 0; row < tb.numTuples(); ++row) {
      ...
      for (int i = 0; i < numComponents; i++) {
        responsibilities[i] = inputColumns.get(indexCounter).getDouble(row);
        indexCounter++;
      }
