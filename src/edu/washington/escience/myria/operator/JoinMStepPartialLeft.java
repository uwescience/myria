 ...
 * 
 */
public final class JoinMStepPartialLeft extends BinaryOperator {
	 ...
	 *        the children.
	 */
	public JoinMStepPartialLeft(final Operator left, final Operator right,
	 ...
	 *        the correct number of columns and column types.
	 */
	public JoinMStepPartialLeft(final List<String> outputColumns,
