...
public class CollectProducer extends GenericShuffleProducer {
  ...
  /**
   * A collector always has one partition, no replication, and exactly one outgoing channel of index
   * 0.
   */
   ...
   * */
  public CollectProducer(final Operator child, final ExchangePairID operatorID,
