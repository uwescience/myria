...
public final class RecoverProducer extends CollectProducer {
  ...
  private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory
      .getLogger(RecoverProducer.class);
   ...
   * */
  public RecoverProducer(final Operator child, final ExchangePairID operatorID,
      final int collectConsumerWorkerID, final Producer oriProducer, final int channelIndx) {
  ...
  protected void childEOS() throws DbException {
    ...
    if (!oriProducer.eos()) {
      ...
      if (LOGGER.isTraceEnabled()) {
        LOGGER.trace("recovery task {} detach & attach channel {} old channel {} new channel {}",
            getOpName(), tmp.getID(), oriProducer.getChannels()[channelIndx], tmp);
      }
      ...
      /*
       * if the task has no new input, but needs to produce potential EOSs & push TBs in its buffers
       * out.
       */
