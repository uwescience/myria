 ...
 * 
 */
public class DbPersist extends RootOperator {
  /** The connection to the database database. */
  private AccessMethod accessMethod;
  /** The information for the database connection. */
  private ConnectionInfo connectionInfo;
  /** The name of the table to persist */
   ...
   */
  public DbPersist(final Operator child, final RelationKey relationKey, final ConnectionInfo connectionInfo) {
    super(child);
  ...
  protected void init(final ImmutableMap<String, Object> execEnvVars) throws DbException {
    ...
    /* we would need to persist the relation here */
  }
