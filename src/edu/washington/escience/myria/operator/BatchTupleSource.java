 ...
 * 
 */
public final class BatchTupleSource extends LeafOperator {
   ...
   */
  public BatchTupleSource(final TupleBatchBuffer data) {
  ...
  public BatchTupleSource(final List<TupleBatch> data) {
    this(data, null);
  }
   ...
   */
  public BatchTupleSource(final TupleBatch data) {
   ...
   */
  public BatchTupleSource(final List<TupleBatch> data, final Schema schema) {
