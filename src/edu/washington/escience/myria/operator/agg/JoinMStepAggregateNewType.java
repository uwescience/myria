...
public class JoinMStepAggregateNewType extends UnaryOperator {
  ...
  private static final org.slf4j.Logger LOGGER =
      org.slf4j.LoggerFactory.getLogger(JoinMStepAggregateNewType.class);
   ...
   */
  public JoinMStepAggregateNewType(@Nullable final Operator child, final int gfield,
  ...
  public JoinMStepAggregateNewType(final Operator child, final int gfield,
      final AggregatorFactory factory, final int numDimensions, final int numComponents) {
    ...
    switch (gColumnType) {
      case LONG_TYPE:
        ...
        if (groupAgg == null) {
          ...
          groupAgg[0] =
              new JoinMStepAggregatorNewType(inputSchema, 55, null, numDimensions, numComponents);
