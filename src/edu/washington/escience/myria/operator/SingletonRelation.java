...
/**
 * A relation of exactly one row. In principle, it should have no columns, but we require there to
 * be at least one.
 * 
 */
public final class SingletonRelation extends LeafOperator {
  ...
  private static final Schema SINGLETON_SCHEMA = Schema.of(ImmutableList.of(Type.INT_TYPE),
      ImmutableList.of("privateSingletonColumn"));
