 ...
 * */
public class CatalogQueryScan extends LeafOperator implements DbReader {
   ...
   * */
  public CatalogQueryScan(final String baseSQL, final Schema outputSchema) {
   ...
   * @param outputSchema see the corresponding field.
   * */
  public CatalogQueryScan(final ConnectionInfo connectionInfo, final String baseSQL, final Schema outputSchema) {
   ...
   */
  public CatalogQueryScan(final RelationKey relationKey, final Schema outputSchema) {
   ...
   * @param outputSchema the Schema of the returned tuples.
   */
  public CatalogQueryScan(final ConnectionInfo connectionInfo, final RelationKey relationKey, final Schema outputSchema) {
   ...
   */
  public CatalogQueryScan(final RelationKey relationKey, final Schema outputSchema, final int[] sortedColumns,
