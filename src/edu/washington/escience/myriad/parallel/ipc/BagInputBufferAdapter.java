...
public abstract class BagInputBufferAdapter<PAYLOAD> extends AttachmentableAdapter implements
   ...
   * 
   * @param msg {@link #offer(edu.washington.escience.myriad.parallel.ipc.IPCMessage.StreamData)}
   * @throws IllegalStateException if the
   *           {@link #offer(edu.washington.escience.myriad.parallel.ipc.IPCMessage.StreamData)} operation should not be
   *           done.
   * */
