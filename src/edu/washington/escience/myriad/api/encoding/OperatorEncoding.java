...
@JsonSubTypes({
    ...
    @Type(name = "Aggregate", value = AggregateEncoding.class), @Type(name = "Project", value = ProjectEncoding.class),
    @Type(name = "Apply", value = ApplyEncoding.class), @Type(name = "SQLiteScan", value = SQLiteScanEncoding.class),
