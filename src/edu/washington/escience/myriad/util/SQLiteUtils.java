...
public final class SQLiteUtils {
   ...
   */
  public static String createStatementFromSchema(final Schema schema,
   ...
   * @return a SQLite CREATE TABLE statement for a table of the given Schema and name.
   */
  public static String createIfNotExistsStatementFromSchema(
   ...
   * @param data the data.
   * */
  public static void insertIntoSQLite(final Schema inputSchema,
      final RelationKey relationKey, final String dbFilePath,
    ...
    SQLiteAccessMethod.tupleBatchInsert(
        ...
        "insert into "
            ...
            + " ( " + StringUtils.join(fieldNames, ',') + " ) values ( "
            + StringUtils.join(placeHolders, ',') + " )", data);
  }
   ...
   */
  public static String insertStatementFromSchema(final Schema schema,
      final RelationKey relationKey) {
    final StringBuilder sb = new StringBuilder();
