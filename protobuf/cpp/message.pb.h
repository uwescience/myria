...
class TransportMessage : public ::google::protobuf::Message {
 public:
  ...
  inline const ::ColumnMessage& data() const;
  inline ::ColumnMessage* mutable_data();
  inline ::ColumnMessage* release_data();
...
inline const ::ColumnMessage& TransportMessage::data() const {
  return data_ != NULL ? *data_ : *default_instance_->data_;
}
inline ::ColumnMessage* TransportMessage::mutable_data() {
  set_has_data();
  if (data_ == NULL) data_ = new ::ColumnMessage;
  return data_;
}
inline ::ColumnMessage* TransportMessage::release_data() {
  clear_has_data();
  ::ColumnMessage* temp = data_;
  data_ = NULL;
  return temp;
}
