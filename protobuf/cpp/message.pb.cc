...
void protobuf_AddDesc_message_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rmessage.proto\032\014column.proto\032\rcontrol.p"
    "roto\032\013query.proto\"\331\001\n\020TransportMessage\0224"
    "\n\004type\030\001 \002(\0162&.TransportMessage.Transpor"
    "tMessageType\022\034\n\004data\030\002 \001(\0132\016.ColumnMessa"
    "ge\022\025\n\005query\030\003 \001(\0132\006.Query\022 \n\007control\030\004 \001"
    "(\0132\017.ControlMessage\"8\n\024TransportMessageT"
    "ype\022\010\n\004DATA\020\000\022\t\n\005QUERY\020\001\022\013\n\007CONTROL\020\002B6\n"
    "$edu.washington.escience.myriad.protoB\016T"
    "ransportProto", 333);
...
void TransportMessage::InitAsDefaultInstance() {
  data_ = const_cast< ::ColumnMessage*>(&::ColumnMessage::default_instance());
...
void TransportMessage::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    type_ = 0;
    if (has_data()) {
      if (data_ != NULL) data_->::ColumnMessage::Clear();
    }
    if (has_query()) {
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_control;
        break;
      }
      
      // optional .ControlMessage control = 4;
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_control:
...
void TransportMessage::MergeFrom(const TransportMessage& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_data()) {
      mutable_data()->::ColumnMessage::MergeFrom(from.data());
    }
    if (from.has_query()) {
